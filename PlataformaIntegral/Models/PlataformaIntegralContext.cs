...
public partial class PlataformaIntegralContext : DbContext
{
    ...
    public virtual DbSet<ClasePresencial> ClasePresencials { get; set; }

    public virtual DbSet<ClaseVirtual> ClaseVirtuals { get; set; }

    public virtual DbSet<ConfiguracionPrivacidad> ConfiguracionPrivacidads { get; set; }
    ...
    public virtual DbSet<ReseñaProfesor> ReseñaProfesors { get; set; }

    public virtual DbSet<Suscripcion> Suscripcions { get; set; }

    public virtual DbSet<SuscripcionTipo> SuscripcionTipos { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Credencial>(entity =>
        {
            ...
            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.Credencials).HasConstraintName("FK_credencial_usuario");
        });
        ...
        modelBuilder.Entity<ReseñaProfesor>(entity =>
        {
            ...
            entity.HasOne(d => d.IdEstudianteNavigation).WithMany(p => p.ReseñaProfesors).HasConstraintName("FK_rp_estudiante");

            entity.HasOne(d => d.IdProfesorNavigation).WithMany(p => p.ReseñaProfesors)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Suscripcion>(entity =>
        {
            ...
            entity.HasOne(d => d.IdEstadoSuscripcionNavigation).WithMany(p => p.Suscripcions).HasConstraintName("FK_suscripcion_estado");

            entity.HasOne(d => d.IdSuscripcionTipoNavigation).WithMany(p => p.Suscripcions).HasConstraintName("FK_suscripcion_tipo");

            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.Suscripcions).HasConstraintName("FK_suscripcion_usuario");
        });
